            ...
            <form className='flex flex-col gap-4'>
                <div className='flex flex-col gap-4 sm:flex-row justify-between'>
                    ...
                    <Select>
                        ...
                        <option value="entrepreneurship-mindset">Entrepreneurship Mindset</option>
                        ...
                        <option value="personal-finance-for-students">Personal Finance for Students</option>
                        ...
                        <option value="diet-nutrition-science">Diet & Nutrition Science</option>
