...
export default function Projects() {
  return (
    <div className='min-h-screen max-w-4xl mx-auto flex justify-center gap-8 items-center flex-col p-6'>
      <h1 className='text-6xl font-bold text-center text-gray-700 dark:text-gray-300'>
        Explore Our Projects
      </h1>
      <p className='text-lg text-gray-500 text-center max-w-3xl dark:text-gray-400'>
      ...
      <div className='w-full flex flex-col gap-6'>
        <section className='bg-gray-200 p-6 rounded-lg shadow-md dark:bg-gray-800'>
